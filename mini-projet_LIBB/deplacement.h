...
#define MAX_SPEED 				200		//Vitesse que nous avons déterminé bonne pour le déplacement de notre robot
#define HALF_MAX_SPEED			100
#define QUARTER_MAX_SPEED		50
#define WIDE_TURN				200		//Nombre de steps pour faire un virage large de 90 degrés
